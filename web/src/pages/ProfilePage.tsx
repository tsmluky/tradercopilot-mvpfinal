                            ...
                            {TOKENS.map(t => {
                                ...
                                return (
                                    <button
                                        ...
                                        className={`px-3 py-1.5 rounded text-xs font-bold border transition-all ${isActive
                                        ...
                                        {[...followed].reverse().map((sig, i) => {
                                            ...
                                            return (
                                                <tr key={i} className="hover:bg-slate-800/50 transition-colors align-top">
                                                    ...
                                                    <td className="p-4">
                                                        <span className={`px-2 py-1 rounded text-[10px] font-bold uppercase ${sig.status === 'WIN' ? 'bg-emerald-500/10 text-emerald-400' :
